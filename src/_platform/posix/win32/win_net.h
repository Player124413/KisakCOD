// win_net.h -- network interface for the POSIX port.
//
// Identical to src/win32/win_net.h except that the implementation (win_net.cpp)
// calls Berkeley sockets directly instead of Winsock. The engine's 12 includers
// see the same declarations either way.
