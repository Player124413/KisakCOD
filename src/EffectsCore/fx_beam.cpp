    ...
    float4 *outFlatDelta)
{
    ...
    int64_t v13; // [esp-118h] [ebp-124h]
    float v14; // [esp-110h] [ebp-11Ch]
    float v15; // [esp-10Ch] [ebp-118h]
    int64_t v16; // [esp-108h] [ebp-114h]
...
bool __cdecl Vec4HomogenousClipZW(float4 *pt0, float4 *pt1, float4 coeffZW)
{
    ...
    int64_t dist1Cmp; // [esp+44h] [ebp-98h]
    int64_t dist1Cmp_8; // [esp+4Ch] [ebp-90h]
    float clipped; // [esp+58h] [ebp-84h]
    int64_t clippeda; // [esp+58h] [ebp-84h]
    float clipped_4; // [esp+5Ch] [ebp-80h]
    float clipped_8; // [esp+60h] [ebp-7Ch]
    int64_t clipped_8a; // [esp+60h] [ebp-7Ch]
    float clipped_12; // [esp+64h] [ebp-78h]
    int64_t dist1Sel1; // [esp+78h] [ebp-64h]
    int64_t dist1Sel1_8; // [esp+80h] [ebp-5Ch]
    int64_t dist0Cmp; // [esp+98h] [ebp-44h]
    int64_t dist0Cmp_8; // [esp+A0h] [ebp-3Ch]
    ...
    int64_t dist1Sel0_8; // [esp+D0h] [ebp-Ch]
